...
Output: runs/output/micro26/read_reg/graphs/read_reg.tex
"""
...
def generate_tikz(data: dict[str, dict[str, float]], output_path: Path) -> None:
    ...
    tex = (
        ...
        r"    ylabel          = {Register reads between overwrites}," "\n"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Plot register reads before overwrite distribution.")
    parser.add_argument(
        "--log-dir",
        type=Path,
        default=LOG_DIR,
